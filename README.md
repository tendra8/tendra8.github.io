...
- Setelah live: di **Google Search Console** → tambahkan domain, submit `https://buanaraya.com/sitemap.xml`, gunakan URL Inspection pada beberapa URL lama untuk memastikan tetap terindeks. Pantau Coverage & Core Web Vitals.
